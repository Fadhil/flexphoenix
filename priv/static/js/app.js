...
})();window.$ = require('jquery');require.register("web/static/js/app", function(exports, require, module) {
"use strict";
...
var channel = socket.channel("work_request_rooms:subtopic", {});
...
function build_message_row(payload) {
  ...
  var message_row = $("<div>").addClass("chat-message " + direction).append($("<img>").attr("src", payload.image).addClass("message-avatar")).append($("<div>").addClass("message").append($("<a href='#'>").addClass("message-author").append(payload.name)).append($("<span>").addClass("message-date").append(new Date($.now()))).append($("<span>").addClass("message-content").append(payload.message)));
  return message_row;
}
...
$(document).ready(function () {
  ...
  var message = $("#message");
  var name = $("#user-display-name").html();
  var image = $("#user-display-image").attr("src");
  var user_id = $("#user-hidden-id").html();
